 ...
 * @author robin
 */
public abstract class AbstractTransformer implements Transformer<String> {
	...
	@Override
	public Content<String> extract(Document docPost, String bakTitle, String parent) {
		...
		Content<String> content = new Content<>(title);
	...
	protected void extract0(Content<String> content, Element ele) {
